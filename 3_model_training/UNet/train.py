...
val_dataloader = DataLoader(val_dataset, batch_size=8, shuffle=False)  # No need to shuffle validation set
...
for epoch in range(num_epochs):
    ...
    if (epoch + 1) % 20 == 0:
        torch.save(model.state_dict(), f'/data/Yi/Surface Albedo/codes/model/unet_model_epoch_{epoch + 1}_512.pth')
# Save
torch.save(model.state_dict(), '/data/Yi/Surface Albedo/codes/model/unet_model_512.pth')
