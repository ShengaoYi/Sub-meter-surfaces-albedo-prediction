...
if __name__ == "__main__":
    MODEL_PATH = "/workspace/ericyi/Surface Albedo/models/UNet/UNet_epoch_100_all_cities_572.pth"
    ...
    for city in cities:
        ...
        INPUT_NAIP_FOLDER = fr"/workspace/ericyi/Surface Albedo/data/{city}/572"
        OUTPUT_FOLDER = fr"/workspace/ericyi/Surface Albedo/data/{city}/Albedo/Albedo_UNet_572"
