...
train_dir_naip = r'/workspace/ericyi/Surface Albedo/data/LA/512/naip_train_RGB'
train_dir_roof = r'/workspace/ericyi/Surface Albedo/data/LA/512/roof_train'

val_dir_naip = r'/workspace/ericyi/Surface Albedo/data/LA/512/naip_test_RGB'
...
log_dir = f'runs/training_ResNet_RGB_200_{current_time}'
# Initialize the TensorBoard writer
writer = SummaryWriter(log_dir)

model = ResNetRegressor(input_channels=3, output_channels=1).to(device)
...
for epoch in range(num_epochs):
    ...
    if (epoch + 1) % 50 == 0:
        torch.save(model.state_dict(),
                   f'/workspace/ericyi/Surface Albedo/data/LA/models/ResNet/ResNet_epoch_{epoch + 1}_RGB_masked_512.pth')
