...
train_dir_naip = r'/workspace/ericyi/Surface Albedo/data/LA/512_RGB/naip_train'
train_dir_roof = r'/workspace/ericyi/Surface Albedo/data/LA/512_RGB/roof_train'

val_dir_naip = r'/workspace/ericyi/Surface Albedo/data/LA/512_RGB/naip_test'
val_dir_roof = r'/workspace/ericyi/Surface Albedo/data/LA/512_RGB/roof_test'
...
log_dir = f'runs/training_CNN_200_{current_time}'
...
for epoch in range(num_epochs):
    ...
    if (epoch + 1) % 50 == 0:
        torch.save(model.state_dict(), f'/workspace/ericyi/Surface Albedo/models/CNN/CNN_epoch_{epoch + 1}_RGB_masked_512.pth')
