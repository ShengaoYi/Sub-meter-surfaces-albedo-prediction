...
log_dir = f'runs/training_FCN_pervious_1024_{current_time}'
...
for epoch in range(num_epochs):
    ...
    if (epoch + 1) % 20 == 0:
        torch.save(model.state_dict(), rf'/workspace/ericyi/Surface Albedo/models/FCN/UNet_epoch_{epoch + 1}_pervious_1024.pth')
