...
for city in cities:
    ...
    naip_output_folder = fr'/workspace/ericyi/Surface Albedo/data/{city}/572/naip_output'
    roof_output_folder = fr'/workspace/ericyi/Surface Albedo/data/{city}/572/roof_output'
    ...
    # 调用示例
    slice_tiff_and_extract_roofs(naip_roof_path, roof_shp_path, naip_output_folder, roof_output_folder, pad_size=30)