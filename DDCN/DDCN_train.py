...
naip_dir = r'/workspace/ericyi/Surface Albedo/data/LA/512/naip_output'
roof_dir = r'/workspace/ericyi/Surface Albedo/data/LA/512/roof_output'
...
log_dir = f'runs/training_DDCN_200_{current_time}'
# Initialize the TensorBoard writer
writer = SummaryWriter(log_dir)

model = DDCN().to(device)
...
for epoch in range(num_epochs):
    ...
    if (epoch + 1) % 20 == 0:
        torch.save(model.state_dict(), rf'/workspace/ericyi/Surface Albedo/data/LA/models/DDCN_epoch_{epoch + 1}_512.pth')
