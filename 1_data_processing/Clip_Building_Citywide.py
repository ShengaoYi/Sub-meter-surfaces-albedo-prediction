...
for city in cities:
    ...
    # 读取 Shapefile
    building_dir = os.path.join(city_dir, 'Buildings')
    boundary_file = os.path.join(building_dir, city + '_buildings.geojson')
    ...
    if len(files) == 1:
        ...
        new_name = '_'.join(new_name_parts) + '_buildings.tif'  # 这将创建如'NAIP_Boston_2023_srid1234.tif'
