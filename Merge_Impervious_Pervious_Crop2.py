...
for city in cities:
    ...
    # 指定文件夹路径
    impervious_path = fr"/workspace/ericyi/Surface Albedo/data/{city}/Albedo/Albedo_UNet_Masked_1024"
    pervious_path = fr"/workspace/ericyi/Surface Albedo/data/{city}/Albedo/Pervious_Albedo_UNet_Masked_1024"
    output_dir = fr"/workspace/ericyi/Surface Albedo/data/{city}/Albedo/Albedo_UNet_Masked_512_Full"
